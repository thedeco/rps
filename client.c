...
/*
Getmove function gets the user's move and returns 1 for good input 0 for bad input
*/
...
/*
Clientplaygame function interacts with the game server
*/
void clientplaygame(int sockfd, char * ipaddr, uint16_t port){
    char ip[16];
    uint16_t tempport;
    char * recv_buffer;
    char answer[10];
...
//Sends Hello Message to server and gets response & prints it--------------
    ...
    printf("%s\n",recv_buffer); 
    clientplaygame(sockfd, ipaddr, port);
}
